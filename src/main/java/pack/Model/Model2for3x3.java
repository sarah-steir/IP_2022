...
public class Model2for3x3 {
    ...
    private double e1, e2, e3; // Holds values in the reduce matrix
    private double a1, a2, a3; // Row 1
    private double b1, b2, b3; //Row 2
    private double c1, c2, c3; // Row 3
    private double a1Initial, a2Initial, a3Initial; // Holds initiql value Row 1
    private double b1Initial, b2Initial, b3Initial; // Holds initial value Row 2
    private double c1Initial, c2Initial, c3Initial; // Holds initial value Row3
