...
public class Model2for2x2 {
    ...
    private double e1, e2; // Holds values in the reduced matrix
    private double a1, a2; // Row 1
    private double b1, b2; // Row 2

    private double a1Initial, a2Initial; // Holds initial value Row 1
    private double b1Initial, b2Initial; // Holds initial value Row 2
